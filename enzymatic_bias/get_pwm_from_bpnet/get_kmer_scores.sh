...
python get_kmer_scores.py --predictions_hdf5_profile /srv/scratch/annashch/bias_correction/enzymatic_bias/profile_model_of_bias/dnase/peak_region_preds_gm12878/gm12878.dnase.0.predictions.0 \
