#!/bin/bash 
#ATAC-seq 
#./bpnet_count_tracks.sh /oak/stanford/groups/akundaje/projects/enzymatic_bias_correction/pipeline_out/atac/SRR072187/call-align/shard-0/execution/SRR072187.4_1.merged.bam &
#DNASE
...
./bpnet_count_tracks.sh /oak/stanford/groups/akundaje/projects/enzymatic_bias_correction/pipeline_out/atac/merged.SRR1565781.SRR1565782.bam
