...
def getModelGivenModelOptionsAndWeightInits(args):
    ...
    conv1_pwm=np.expand_dims(np.transpose(np.loadtxt("/srv/scratch/annashch/bias_correction/enzymatic_bias/get_pwm_from_kmer/pwm.vierstra_et_al.6mer-model.txt")),axis=-1)
