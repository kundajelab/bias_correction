...
CUDA_VISIBLE_DEVICES=2 kerasAC_cross_validate --index_data_path /srv/scratch/annashch/bias_correction/genomewide_labels/classificationlabels.SummitWithin200bpCenter.hdf5 \
		    --input_data_path seq /srv/scratch/annashch/bias_correction/genomewide_gc/gc_hg38_nosmooth.central200.hdf5 \
		    ...
		    --num_inputs 2 \
		    --num_outputs 1 \
		    --model_hdf5 $CELL_LINE/DNASE.$CELL_LINE.classificationlabels.withgc \
		    ...
		    --patience_lr 2 \
		    --expand_dims \
		    --predictions_and_labels_hdf5 $CELL_LINE/predictions.DNASE.$CELL_LINE.classificationlabels.withgc \
		    --performance_metrics_classification_file $CELL_LINE/performance.DNASE.$CELL_LINE.classificationlabels.withgc \
